export const projects = [
  {
    ...
    description: "A fully responsive personal portfolio built using React and Tailwind CSS.",
    tech: ["React", "Tailwind"],
...

  {
    ...
    description: "A complete e-commerce app with cart, filters, and Redux state management.",
